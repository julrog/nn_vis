...
class RenderingConfig(BaseConfig):
    ...
    def set_defaults(self) -> None:
        ...
        shader_items.extend([('screen_width', 'screen_width', 'Screen Width', 1920.0),
                             ...
                             ('edge_object_radius', 'object_radius', 'Size', 0.02),
                             ('edge_base_opacity', 'base_opacity',
                              'Base Opacity', 0.0),
                             ('edge_importance_opacity', 'importance_opacity',
                              'Importance Opacity', 1.1),
                             ('edge_depth_opacity', 'depth_opacity',
                              'Depth Opacity', 0.5),
                             ('edge_opacity_exponent',
                              'opacity_exponent', 'Depth Exponent', 0.25),
                             ('edge_importance_threshold', 'importance_threshold',
                              'Importance Threshold', 0.01),
                             ('node_object_radius', 'object_radius', 'Size', 0.04),
                             ('node_base_opacity', 'base_opacity',
                              'Base Opacity', 0.0),
                             ('node_importance_opacity', 'importance_opacity',
                              'Importance Opacity', 1.0),
                             ('node_depth_opacity', 'depth_opacity',
                              'Depth Opacity', 0.5),
                             ('node_opacity_exponent',
                              'opacity_exponent', 'Depth Exponent', 0.5),
