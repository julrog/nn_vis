...
def set_render_frame(gui_root: Tk, change_render_config: Callable, change_setting: Callable,
    ...
    RenderSettings(render_frame, "Grid", change_render_config, render_config, "grid_render_mode", None, row=0, column=0)
    ...
    class_setting_frame: LabelFrame = LabelFrame(render_frame, text="Class Visibility", width=60, padx=5, pady=5)
...
def set_architecture_frame(gui_root: Tk, save_processed_nn_file: Callable,
    ...
    architecture_frame: LabelFrame = LabelFrame(gui_root, text="Neural Network Architecture", width=60, padx=5, pady=5)
    ...
    load_button: Button = Button(architecture_frame, text="Load Network", width=20, command=open_importance_file)
    load_button.grid(row=2, column=0, columnspan=3)
    generate_button: Button = Button(architecture_frame, text="Generate Network", width=20, command=generate)
...
def set_processing_frame(gui_root: Tk, processing_config: ProcessingConfig, change_setting: Callable,
    ...
    action_frame: LabelFrame = LabelFrame(processing_frame, text="Actions", width=60, padx=5, pady=5)
    ...
    setting_frame: LabelFrame = LabelFrame(processing_frame, text="Settings", width=60, padx=5, pady=5)
